      ...
      <section className="bg-card py-16 px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg font-light text-muted-foreground max-w-2xl mx-auto">
            High-performance essentials engineered for the modern athlete. Where function meets form in every detail.
          </p>
        </div>
      </section>
            ...
            <div className="mt-4 pt-4 border-t border-border">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {["Tops", "Bottoms", "Outerwear", "Compression"].map((type) => (
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {["Under $100", "$100-$150", "$150-$200", "Over $200"].map((price) => (
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {["Black", "White", "Navy", "Grey", "Olive"].map((color) => (
