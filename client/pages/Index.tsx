    ...
    <main className="min-h-screen bg-background relative">
      ...
      <section className="py-20 px-8 bg-card">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-base font-light text-muted-foreground mb-6">Aly + Andy Z is not fast fashion. We create capsule collections — small‑batch, seasonless, versatile �� designed for modern lives lived with intention.</p>
      ...
      <section className="py-20 px-8 bg-background">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <Link to="/our-impact" className="inline-flex items-center justify-center px-8 py-3 rounded-sm uppercase tracking-wider text-sm mt-4 bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-300">Learn More About Our Impact →</Link>
        </div>
      </section>
