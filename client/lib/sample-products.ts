...
// Riviera capsule individual items (added so capsule pieces link to real PDPs)
const rivieraProducts: Product[] = [
  {
    id: "riv-01",
    name: "Lightweight Long Coat",
    price: 69,
    image: "https://cdn.builder.io/api/v1/image/assets%2F514b6cfd929047f0b5e645c455c5c65f%2F6253de9ff1d4492aa94371f79811ab22?format=webp&width=1600",
    options: ["XS", "S", "M", "L", "XL"],
    description: "A long, lightweight coat tailored for coastal evenings—layer over everything.",
    images: ["https://cdn.builder.io/api/v1/image/assets%2F514b6cfd929047f0b5e645c455c5c65f%2F6253de9ff1d4492aa94371f79811ab22?format=webp&width=1600"],
  },
  {
    id: "riv-02",
    name: "Cropped Top",
    price: 22,
    image: "https://cdn.builder.io/api/v1/image/assets%2F514b6cfd929047f0b5e645c455c5c65f%2F36ed3280fa7d4625b4d01bd561184f5e?format=webp&width=1600",
    options: ["XS", "S", "M", "L"],
    description: "A clean, cropped tank for layering or standalone wear.",
    images: ["https://cdn.builder.io/api/v1/image/assets%2F514b6cfd929047f0b5e645c455c5c65f%2F36ed3280fa7d4625b4d01bd561184f5e?format=webp&width=1600"],
  },
  {
    id: "riv-03",
    name: "Cargo Pants",
    ...
    image: "https://cdn.builder.io/api/v1/image/assets%2F514b6cfd929047f0b5e645c455c5c65f%2F6253de9ff1d4492aa94371f79811ab22?format=webp&width=1600",
    options: ["S", "M", "L"],
    description: "Relaxed cargo pants with utility pockets and tapered cuff.",
    images: ["https://cdn.builder.io/api/v1/image/assets%2F514b6cfd929047f0b5e645c455c5c65f%2F6253de9ff1d4492aa94371f79811ab22?format=webp&width=1600"],
  },
  {
    id: "riv-04",
    name: "Cap",
    price: 20,
    image: "https://cdn.builder.io/api/v1/image/assets%2F514b6cfd929047f0b5e645c455c5c65f%2F767064950ef640a3800a8e3f589bcfee?format=webp&width=1200",
    options: ["One Size"],
    description: "Minimal cap finished in washed cotton.",
    images: ["https://cdn.builder.io/api/v1/image/assets%2F514b6cfd929047f0b5e645c455c5c65f%2F767064950ef640a3800a8e3f589bcfee?format=webp&width=1200"],
  },
  {
    id: "riv-05",
  ...
  },
  {
    ...
    image: "https://cdn.builder.io/api/v1/image/assets%2F514b6cfd929047f0b5e645c455c5c65f%2F767064950ef640a3800a8e3f589bcfee?format=webp&width=1200",
    options: ["One Size"],
    description: "Compact utility bag with adjustable strap.",
    images: ["https://cdn.builder.io/api/v1/image/assets%2F514b6cfd929047f0b5e645c455c5c65f%2F767064950ef640a3800a8e3f589bcfee?format=webp&width=1200"],
  },
];

export const allProducts = [...sampleProducts, ...readyToWearProducts, ...mensReadyToWearProducts, ...mensActivewearProducts, ...rivieraProducts];
