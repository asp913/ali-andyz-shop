...
interface MensReadyToWearClientProps {
  products: Product[];
  hasError?: boolean;
}

export default function MensReadyToWearClient({ products, hasError = false }: MensReadyToWearClientProps) {
          ...
          <div className="mb-8 p-6 border border-border rounded-sm bg-card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {["Shirts", "Pants", "Jackets", "Blazers"].map((type) => (
