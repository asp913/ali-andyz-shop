...
export const capsuleDetailsByProductId: Record<string, CapsuleDetails | undefined> = {
  ...
  'wa-009': {
    capsuleTitle: 'Design Your Own Activewear Capsule',
    capsuleSubtitle:
      'Build your active set your way. Pick your favorites from this collection.',
    bundlePrice: 0,
    bundleValue: 0,
    priceRangeCopy: 'Price range $18–$79. 4–5 items = 15% off · 6+ = 20% off at checkout',
    sizeGuideHref: '/size-guide',
    items: [
      {
        handle: 'performance-crop-top',
        title: 'Performance Crop Top',
        price: 32,
        priceStripeId: '',
        sizes: ['XS', 'S', 'M', 'L', 'XL'],
        inventoryLeft: 12,
      ...
      },
      {
        ...
        title: 'High-Waisted Performance Leggings',
        price: 45,
        priceStripeId: '',
        sizes: ['XS', 'S', 'M', 'L', 'XL'],
        inventoryLeft: 8,
      ...
      {
        handle: 'mesh-sports-bra',
        title: 'Mesh Panel Sports Bra',
        price: 28,
        priceStripeId: '',
        sizes: ['XS', 'S', 'M', 'L', 'XL'],
        inventoryLeft: 15,
      ...
      },
      {
        ...
        title: 'High-Rise Training Shorts',
        price: 38,
        priceStripeId: '',
        sizes: ['XS', 'S', 'M', 'L', 'XL'],
        inventoryLeft: 10,
      ...
      {
        handle: 'seamless-tank',
        title: 'Seamless Training Tank',
        price: 26,
        priceStripeId: '',
        sizes: ['XS', 'S', 'M', 'L', 'XL'],
        inventoryLeft: 14,
      ...
      },
      {
        ...
        title: 'Moisture-Wicking Long Sleeve',
        price: 35,
        priceStripeId: '',
        sizes: ['XS', 'S', 'M', 'L', 'XL'],
        inventoryLeft: 11,
      ...
      },
      {
        ...
        title: 'Quick-Dry Performance Tee',
        price: 29,
        priceStripeId: '',
        sizes: ['XS', 'S', 'M', 'L', 'XL'],
        inventoryLeft: 16,
      ...
      {
        handle: 'crossover-bra',
        title: 'Crossover Back Sports Bra',
        price: 31,
        priceStripeId: '',
        sizes: ['XS', 'S', 'M', 'L', 'XL'],
        inventoryLeft: 12,
      ...
      {
        handle: 'athletic-skort',
        title: 'Tennis-Style Athletic Skort',
        price: 44,
        priceStripeId: '',
        sizes: ['XS', 'S', 'M', 'L', 'XL'],
        inventoryLeft: 8,
      ...
      },
      {
        ...
        title: 'Cushioned Performance Socks (3-Pack)',
        price: 18,
        priceStripeId: '',
        sizes: ['S/M', 'L/XL'],
        inventoryLeft: 20,
