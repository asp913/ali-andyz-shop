        ...
        <div className="relative z-10 h-full max-w-6xl mx-auto px-6 flex items-end pb-10">
          <div className="text-white">
            ...
            <div className="mt-6 flex gap-3">
              <Link href="/womens-ready-to-wear"><Button variant="default">Shop Women&apos;s</Button></Link>
              <Link href="/mens-ready-to-wear"><Button variant="secondary" className="bg-white/90 text-black hover:bg-white">Shop Men&apos;s</Button></Link>
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="grid gap-8 items-start md:grid-cols-2">
                <div className="text-lg font-light text-muted-foreground leading-relaxed space-y-4">
                  ...
                  <div className="mt-8">
                    ...
                    <Link href="/" className="inline-flex items-center justify-center px-6 py-3 rounded-sm uppercase tracking-wider text-sm mt-4 bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-300">Explore Capsules With Purpose →</Link>
                  </div>
                </div>
