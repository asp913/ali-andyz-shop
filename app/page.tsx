    ...
    <main className="min-h-screen bg-background relative">
      ...
      <section className="min-h-[85vh] overflow-hidden flex items-center justify-center bg-background">
        <div className="flex flex-col-reverse lg:flex-row max-w-7xl w-full items-center">
          <div className="flex flex-col justify-center px-8 py-16 lg:px-12 lg:py-0 flex-1 text-center lg:text-left">
            <div className="text-sm mb-4 text-muted-foreground tracking-[0.3em] uppercase">
              Aly + Andy Z
            </div>
            ...
            <p className="text-lg font-light tracking-wide mt-6 mb-8 text-muted-foreground max-w-lg mx-auto lg:mx-0">
              Clarity. Creativity. Mindfulness. Our Aly / Dali / Lami philosophy
              transforms getting dressed into a practice of balance. Each
              edition blends ready‑to‑wear and activewear into a wardrobe that
              moves effortlessly between studio, street, travel, and retreat.
            </p>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-3xl lg:text-4xl font-light text-foreground tracking-wide mb-4">
              Mindful Movement. Timeless Style.
            </h2>
            <p className="text-base font-light text-muted-foreground mb-6">
              Aly + Andy Z is not fast fashion. We create capsule collections —
              small‑batch, seasonless, versatile pieces designed for modern
              lives lived with intention.
            </p>
            <ul className="space-y-3 text-lg font-light text-muted-foreground">
              <li>
                <strong className="text-foreground">Aly = Clarity.</strong>{" "}
                Minimal silhouettes, grounding tones, precision tailoring.
              </li>
              <li>
                <strong className="text-foreground">Dali = Creativity.</strong>{" "}
                Playful accents, sculptural textures, art‑inspired expression.
              </li>
              <li>
                <strong className="text-foreground">Lami = Mindfulness.</strong>{" "}
                Flowing fabrics, quiet luxury, ease of travel and retreat.
              </li>
            </ul>
            <p className="text-base text-muted-foreground mt-6">
              Together, they form our philosophy: clarity, creativity, and
              mindfulness woven into every edition.
            </p>
          </div>
      ...
      <section className="py-20 px-8 bg-background">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-3xl lg:text-4xl font-light text-foreground tracking-wide mb-2">
            Move With Heart
          </h2>
          <p className="text-lg font-light text-muted-foreground max-w-3xl mx-auto">
            Through Aly's personal friendship with a monk in Manali, Himachal
            Pradesh, we help provide food, education, and a safe home for
            Tibetan refugee children.
          </p>
          <p className="text-base text-muted-foreground">
            Your style becomes their support.
          </p>
          <Link
            href="/our-impact"
            className="inline-flex items-center justify-center px-8 py-3 rounded-sm uppercase tracking-wider text-sm mt-4 bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-300"
          >
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 text-center">
          <div className="border border-border rounded-sm p-6">
            ...
            <p className="text-muted-foreground">
              Performance activewear that moves with you, from class to café.
            </p>
          </div>
          <div className="border border-border rounded-sm p-6">
            <h3 className="text-lg font-medium text-foreground mb-2">
            ...
            <p className="text-muted-foreground">
              Tailored essentials that work in motion and at arrival.
            </p>
          </div>
          <div className="border border-border rounded-sm p-6">
            <h3 className="text-lg font-medium text-foreground mb-2">
            ...
            <p className="text-muted-foreground">
              Soft, elevated layers designed for mindfulness and restoration.
            </p>
          </div>
          <p className="md:col-span-3 text-sm text-muted-foreground">
            Each capsule transcends seasons. Each piece is designed to live many
            lives.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid sm:grid-cols-3 gap-6 text-center">
          <div className="border border-border rounded-sm p-6">
            ...
            <div className="text-muted-foreground">
              Every piece is curated and verified in‑house.
            </div>
          </div>
          <div className="border border-border rounded-sm p-6">
            <div className="text-sm font-semibold text-foreground">
            ...
            <div className="text-muted-foreground">
              From New York & Los Angeles to the world.
            </div>
          </div>
          <div className="border border-border rounded-sm p-6">
            <div className="text-sm font-semibold text-foreground">
            ...
            <div className="text-muted-foreground">
              Worn by capsule collectors and tastemakers.
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-card py-20 px-8">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <h2 className="text-3xl lg:text-4xl font-light text-foreground tracking-wide">
            Never Miss a Capsule.
          </h2>
          <p className="text-lg text-muted-foreground">
            Join an exclusive circle for early access to editions, editorial
            stories, and private cultural events.
          </p>
          ...
          <p className="text-sm text-muted-foreground">
            Aly + Andy Z is not mass fashion. It's a philosophy, a practice, a
            uniform for intentional living. Welcome to the collective.
          </p>
        </div>
      </section>
