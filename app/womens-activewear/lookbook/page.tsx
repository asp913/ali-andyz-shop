...
export default async function WomensActivewearLookbook() {
  let products = [];
  try {
      ...
      <section className="px-6 py-8">
        <div className="max-w-6xl mx-auto rounded-sm overflow-hidden relative bg-card">
          ...
          <div className="absolute bottom-6 left-6 right-6 md:left-10 md:bottom-10 text-background">
            ...
            <Link href="/womens-activewear#collection" className="mt-3 inline-block bg-background text-foreground px-4 py-2 rounded-sm text-sm">Shop Performance →</Link>
          </div>
        </div>
      </section>
