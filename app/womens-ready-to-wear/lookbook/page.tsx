      ...
      <section className="px-6 py-8">
        <div className="max-w-6xl mx-auto rounded-sm overflow-hidden relative bg-card">
          ...
          <div className="absolute bottom-6 left-6 right-6 md:left-10 md:bottom-10 text-background">
            ...
            <Link href="/womens-ready-to-wear" className="mt-3 inline-block bg-background text-foreground px-4 py-2 rounded-sm text-sm">Shop the Collection →</Link>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-12">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="mt-5 flex items-center justify-center gap-3">
            <Link href="/womens-ready-to-wear" className="inline-block bg-foreground text-background px-5 py-3 rounded-sm">Shop Ready-to-Wear →</Link>
            <Link href="/book-session" className="inline-block border border-border px-5 py-3 rounded-sm">Book a Styling Session →</Link>
          </div>
