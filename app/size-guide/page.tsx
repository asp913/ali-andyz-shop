...
function SizeGuideContent() {
  ...
  const initialTab = useMemo(() => {
    ...
    if (hash.includes("men") || gender === "men") return "men";
    if (hash.includes("women") || gender === "women") return "women";
    return "women";
  }, [searchParams]);
  ...
  return (
    <main className="min-h-screen bg-background px-6 py-10">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8">
          <Link href="javascript:history.back()" className="underline text-sm">Back</Link>
        </div>
      </div>
    </main>
  );
